...
/**
 * PassRequestFields Class Doc Comment
 *
 * @category Class
 * @package  WalletPassJP
 * @author   Kinchaku
 */
class PassRequestFields implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PassRequest_fields';
...
'change_message' => 'getChangeMessage'    ];
     ...
     * Sets change_message
     *
     * @param string $change_message ​If you don’t specify a change message, customer won't be notified of the changes.
     *
     * @return $this
     */
