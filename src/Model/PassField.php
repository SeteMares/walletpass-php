...
const GOOGLE_POSITION_LOYALTY_MEMBER_SINCE = 'loyalty_member_since';
const GOOGLE_POSITION_LOYALTY_DEPARTMENT = 'loyalty_department';
const GOOGLE_POSITION_LOYALTY_EMPLOYEE_ID = 'loyalty_employee_id';
const GOOGLE_POSITION_LOYALTY_CONTACT_ID = 'loyalty_contact_name';
const GOOGLE_POSITION_LOYALTY_CONTACT_PICTURE = 'loyalty_contact_picture';
...
self::GOOGLE_POSITION_LOYALTY_MEMBER_SINCE,
self::GOOGLE_POSITION_LOYALTY_DEPARTMENT,
self::GOOGLE_POSITION_LOYALTY_EMPLOYEE_ID,
self::GOOGLE_POSITION_LOYALTY_CONTACT_ID,
self::GOOGLE_POSITION_LOYALTY_CONTACT_PICTURE,
