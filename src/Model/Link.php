...
class Link implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'web';
    }
     ...
     * Sets type
     *
     * @param string $type Used to specify the type of link for link field. Each type has different icon on Google Pay.   - `web`: A link to website.  - `tel`: A phone number.  - `email`: An email address.  - `location`: A location address.  - `calendar`: A calendar event.
     *
     * @return $this
     */
