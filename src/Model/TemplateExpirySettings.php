...
/**
 * TemplateExpirySettings Class Doc Comment
 *
 * @category Class
 * @package  WalletPassJP
 * @author   Kinchaku
 */
class TemplateExpirySettings implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Template_expiry_settings';
...
'expires_at' => 'getExpiresAt'    ];
     ...
     * Sets expires_in
     *
     * @param int $expires_in Days after installation
     *
     * @return $this
     */
     ...
     * Sets expires_at
     *
     * @param \DateTime $expires_at Expires on a specific date.
     *
     * @return $this
     */
