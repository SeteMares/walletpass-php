...
/**
 * SettingsStampCard Class Doc Comment
 *
 * @category Class
 * @package  WalletPassJP
 * @author   Kinchaku
 */
class SettingsStampCard implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SettingsStampCard';
    ...
    {
        $this->container['total_stamps'] = isset($data['total_stamps']) ? $data['total_stamps'] : null;
    }
    ...
    {
        return $this->container['total_stamps'];
    }

    /**
     * Sets total_stamps
     *
     * @param int $total_stamps total_stamps
     *
     * @return $this
     */
    public function setTotalStamps($total_stamps)
    {
        $this->container['total_stamps'] = $total_stamps;
