...
/**
 * TemplateRequestLinks Class Doc Comment
 *
 * @category Class
 * @package  WalletPassJP\Client
 * @author   Kinchaku
 */
class TemplateRequestLinks implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TemplateRequest_links';
    ...
    protected static $swaggerTypes = [
        'list' => '\WalletPassJP\Client\Model\Link[]',
'position' => 'string'    ];
...
self::POSITION_PREPEND,        ];
     ...
     * Sets list
     *
     * @param \WalletPassJP\Client\Model\Link[] $list list
     *
     * @return $this
     */
