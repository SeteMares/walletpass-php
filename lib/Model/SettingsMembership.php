...
/**
 * SettingsMembership Class Doc Comment
 *
 * @category Class
 * @package  WalletPassJP\Client
 * @author   Kinchaku
 */
class SettingsMembership implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SettingsMembership';
    ...
    {
        $this->container['has_points'] = isset($data['has_points']) ? $data['has_points'] : false;
    }
    ...
    {
        return $this->container['has_points'];
    }

    /**
     * Sets has_points
     *
     * @param bool $has_points has_points
     *
     * @return $this
     */
    public function setHasPoints($has_points)
    {
        $this->container['has_points'] = $has_points;
