 ...
 *
 * @category Class
 * @description If the specified certificate exists in our system, and the pass_type_identifier and team_identifier match the existing certificate, it will be updated.
 * @package  WalletPassJP\Client
 * @author   Kinchaku
 */
...
'default' => 'getDefault'    ];
     ...
     * Sets certificate
     *
     * @param string $certificate A base64-encoded string of the p12 certificate with the private key.
     *
     * @return $this
     */
     ...
     * Sets password
     *
     * @param string $password The password for the p12 file, if the certificate was exported with a password.
     *
     * @return $this
     */
     ...
     * Sets default
     *
     * @param bool $default If you have multiple certificates and set a new default to `true`, the current default is set to `false`.
     *
     * @return $this
     */
